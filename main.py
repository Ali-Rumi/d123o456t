...
class TradingStrategy:
    ...
    def run_bnb_long(self):
        try:
            subprocess.Popen(["python", "dot_long.py"])
            print("Running dot_long.py")
        except Exception as e:
            print(f"Error running dot_long.py: {e}")

    def run_bnb_short(self):
        try:
            subprocess.Popen(["python", "dot_short.py"])
            print("Running dot_short.py")
        except Exception as e:
            print(f"Error running dot_short.py: {e}")
